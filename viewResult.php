...
<span class="labels" style="color:#0004ff;">Name : <?php echo $name;?><br>Roll No.: <?php echo $roll;?><br>Semester : <?php echo $sem;?></span>
...
<tr><td class="labels" style="text-decoration:underline;color:#000000;">Subject</td><td class="labels" style="text-decoration:underline;color:#000000;">Marks</td></tr>
...
<tr style="text-decoration:underline;color:#000000;"><td class="labels">Total : </td><td class="labels"><?php echo $b['total'];?> %</td></tr>
<tr><td class="labels">Result : </td><td style="color:#0F0;"><?php echo $b['result'];?></td></tr>
<tr>
	<td colspan="2" align="center">
    	<a href="<?php echo $b['url'];?>" class="link">View/Download Answer Sheets</a>
